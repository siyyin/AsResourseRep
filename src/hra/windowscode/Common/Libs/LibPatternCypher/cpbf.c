...
/**************************** VARIABLES *****************************/
static const BF_WORD p_perm[18] = {
...
static const BF_WORD s_perm[4][256] = { {
...
void cpbf_setup(const BF_BYTE user_key[], BLOWFISH_KEY *keystruct, size_t len)
{
   ...
   memcpy(keystruct->p,p_perm,sizeof(BF_WORD) * 18);
   memcpy(keystruct->s,s_perm,sizeof(BF_WORD) * 1024);
   ...
   for (idx = 0; idx < 18; idx += 2) {
      cpbf_encrypt(block,block,keystruct);
